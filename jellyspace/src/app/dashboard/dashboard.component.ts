...
export class DashboardComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, config: NgbModalConfig,private service:AppService,
  ...
  ngOnInit(): void {
    ...
    this.amountList1 = [
      ...
      {label:' Very small project (₹12,500.00 - 37,500.00 INR) ', value:'0'},
      ...
      {label:'  Very Large project (₹500,000.00 - 1,000,000.00 INR)  ', value:'0'},
      {label:'   Huge project (₹1,000,000.00 - 2,500,000.00 INR)   ', value:'0'},
    ...
    this.usdFixedList = [
      ...
      {label:'   Very Large project ($10,000.00 - 20,000.00 USD)  ', value:'0'},
    ...
    this.nzdFixedList = [
      ...
      {label:'  Very Large project ($10,000.00 - 20,000.00 NZD) ', value:'0'},
    ...
    this.audFixedList = [
      ...
      {label:'  Very Large project ($10,000.00 - 20,000.00 AUD) ', value:'0'},
    ...
    this.gbpFixedList = [
      ...
      {label:'  Very Large project ($10,000.00 - 20,000.00 GBP) ', value:'0'},
    ...
    this.hkdFixedList = [
      ...
      {label:'  Very Large project ($80,000.00 - 160,000.00 HKD)   ', value:'0'},
    ...
    this.sgdFixedList = [
      ...
      {label:'  Very Large project ($10,000.00 - 20,000.00 SGD) ', value:'0'},
    ...
    this.eurFixedList = [
      ...
      {label:'  Very Large project ($10,000.00 - 20,000.00 EUR) ', value:'0'},
    ...
    this.cadFixedList = [
      ...
      {label:'  Very Large project ($10,000.00 - 20,000.00 CAD) ', value:'0'},
    ...
    this.postingList = [
      {title:'Standard Project',description:'Your Project will go live instantly & youcan start receiving the bids.', icon:'standard-icon.png', isChecked:false},
      {title:'NDA Project',description:'Before onboarding the personnels, a Non-Disclosure Agreement will be signed. Binds them to maintain Project Confidentiality.', icon:'nda-icon.png', isChecked:false},
      {title:'Project based on IP',description:'The bidding personnels will be prompted to sign an Intellectual Property (IP) Agreement. All work done on the Project will be yours.', icon:'ip-icon.png', isChecked:false},
      {title:'Featured',description:'Choose this when you want to mark your Project as Featured to attract more Quality Bids and get search engine optimized for display & attention.', icon:'featured-icon.png', isChecked:false},
      {title:'Urgent',description:'Choose this when you want to attract bidders who are ready to kick-off the Project and can be onboarded right now. The bidding remains open for only 24hrs.', icon:'urgent-icon.png', isChecked:false},
      {title:'Private Project',description:'Your Project will not be visible in any search engine. Only logged in users at JELLYSPACE will be able to view it.You can even restrict the Project to your Favorite individuals.', icon:'privte-icon.png', isChecked:false},
      {title:'Sealed Project',description:'The bids on the Project will not be visible openly. This way you get to select the best bid.', icon:'sealed-icon.png', isChecked:false},
      {title:'Full Time',description:'Choose this option when you have a Project that is long-term or needs extended support from the hired personnels.', icon:'fulltime-icon.png', isChecked:false},
    ]
    this.payHoursList = [
      {title:'Pay Per Hour',description:'Hire Based On an Hourly Rate Billing Is Done For The Hours Utilized On The Project', icon:'pay-icon.png', isChecked:false},
      {title:'Pay a Fixed Price',description:'Agree On a Price and Execute Payment When The Job is Completed BestFor Single Fixed-task or One-Off Project', icon:'pay-fixed-icon.png', isChecked:false}
    ]
  }
  ...
  getCurrentBidDetails() {
    ...
    this.service.getCurrentBidDetailsList(params).subscribe((res:any) => {
      var list = res['data'];
      this.currentBidProjectDetailsList = list.filter((obj : any) => obj.status == "pending");
      this.accepttBidProjectDetailsList = list.filter((obj : any) => obj.status == "accepted");
      console.log(res)
    })
  }
  cancelForm() {
...
viewProfile() {
  let params = { }
  this.router.navigate(['view-profile'],{  queryParams: params,skipLocationChange: false });
}
viewProfile1() {
  let params = { }
  this.router.navigate(['company-profile'],{  queryParams: params,skipLocationChange: false });
}
setDefault(){
